...
<div align=center>
 ...
 style='width:581.25pt;mso-cellspacing:0in;mso-padding-alt:0in 0in 0in 0in'>
    <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;height:52.5pt'>
      ...
      <td colspan=3 style='background:white;padding:0in 0in 0in 0in;height:52.5pt'><table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width=675
  ...
  height:52.5pt' background="images/pagebgright.gif"><p class=MsoNormal111>
    ...
    <tr >
      <td colspan=3 ><table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width=675
   style='width:506.25pt;mso-cellspacing:0in;mso-padding-alt:0in 0in 0in 0in'
   id="Table_05" height="100%">
          <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
    ...
    height=33 id="_x0000_i1037" src="images/navtablebgright.gif">
		  ...
		  <tr >
      				<td align='left'  ><font size="+1" face="Book Antiqua">Welcome! <%=user %></font></td>
					<td align='right' colspan=7  width="100%"><a href="Search.jsp" ><font size="+1" face="Book Antiqua" color="green">Back to Search! </font></a></td
    	></tr>
		<tr width=""  >
      <td align='left' colspan="8" height="100%"><form name="form1" method="post" action="Truthalgorithm.jsp">
	...
	if(resultfiles.length!=0&&resultfiles.length>5)
	{
		...
		{
			out.println("<center>Result files End..........</center>");
		}
	...
	<td colspan="8">
	<table align="center">
	<tr><td><img src="images/truth.bmp" width="200" height="20"></td></tr>
	<tr> <td align="center"> <a href="Truthfinder.jsp?value=redirect"><font color="#FF0000"> 1 </a> <a href="Truthremaining.jsp?value=redirect"><font color="#FF0000"> 2 </a></td></tr>
	</table>
	</td>
	</tr>
        </table>
