 ...
 <tr style='mso-yfti-irow:1;height:24.75pt'>
  ...
  <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width=675
   ...
   <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
    ...
    <td style='padding:0in 0in 0in 0in'>
    <p class=MsoNormal><span style='font-family:Book Antiqua'><img width=205
    height=33 id="_x0000_i1037" src="images/navtablebgright.gif"><o:p></o:p></span></p>
	</td>
   </tr>
  </table>
   <h1><span style='font-family:Tahoma'><font color="blue">About The Project</font><o:p></o:p></span></h1>
  <p><span style='font-size:8.5pt'>
...
<br> <br>
                    ...
                    In this project, we propose a data exploration approach exploiting information visualization in order to involve tutors in a visual data mining process aiming to detect structures, patterns, and relations between data, which can potentially reveal previously unknown knowledge inherent in tests, such as the test strategies used by the learners, correlations among different questions, and many other aspects, including their impact on the final score <br><br>

                    It captures the occurrence of question browsing and answering events by the learners and uses these data to visualize charts containing a chronological review of tests. Other than identifying the most frequently employed strategies, the tutor can determine their effectiveness by correlating their use with the final test scores. <br><br>

				 <h1><span style='font-family:Tahoma'><font color="blue">Future Enhancement</font><o:p></o:p></span></h1>
				  <p><span style='font-size:8.5pt'>
                         The Test can be conducted to the whole class at a time.
The other behaviors of the user can also be monitored.
The test can be used for other environment such as aptitude test in interviews, Stress analysis test etc.
The project can be enhanced to devise new visual representations and perform further experiments, possibly in combination with classical data mining algorithms.                                                                                                                             <br><br>
...
<br><br>
 ...
 <h1><span style='font-family:Tahoma'><font color="blue">Conclusion</font><o:p></o:p></span></h1>
  <p><span style='font-size:8.5pt'>
 ...
 <tr style='mso-yfti-irow:4;height:39.75pt'>
  ...
  <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width=675
   ...
   <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
    ...
    <area shape=Rect    coords="270, 18, 327, 37"><a href="Products.jsp">
    <area shape=Rect coords="328, 18, 382, 37"><a href="Services.jsp">
    </map><img border=0 width=495 height=53  id="_x0000_i1053" src="images/basebgmid.gif" usemap="#MicrosoftOfficeMap0"><o:p></o:p></span></p>
    </td>
    <td style='padding:0in 0in 0in 0in'>
