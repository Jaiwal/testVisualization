...
ResultSet rs=st.executeQuery("select location from Factdb where about='"+searchword+"' ");
	...
	String names=location.replace('\\','&');
	filenames=names.split("&");
	String txt=filenames[filenames.length-1].replaceAll(".txt","");
	 filena=txt;
...
<td align='right' colspan=7  width="100%"><a href="Search.jsp" ><font size="+1" face="Book Antiqua" color="green">Back to Search! </font></a></td>
		...
		<tr   >
      <td align='left' colspan="8" ><form name="form1" method="post" action="Bestone.jsp?value=again">
	...
	<tr height="100%"><td colspan="8"><a href=""><%= filena %></a><br><%=fact%></td></tr>
	<tr>
	<td colspan="8">
	<table align="center">
	<tr><td><img src="images/truth.bmp" width="200" height="20"></td></tr>
	<tr> <td align="center" > <a href="Truthfinder.jsp?value=null"> <font color="#FF0000"> 1 </a> <a href="Truthremaining.jsp?value=null"><font color="#FF0000"> &nbsp;2 </a></td></tr>
	</table>
	</td>
	</tr>
        </table>
